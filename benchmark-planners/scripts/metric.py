...
def main():
    ...
    # Set map to use, other options: 100by100_20, 100by100_15, 100by100_10, rcll-2017-map-save.yaml
    map_path = os.getcwd() + '/' + glob.glob('**/rcll-2017-map-save.yaml', recursive=True)[0]
    ...
    planners = ['Astar','Dijkstar','Smac2D','SmacHybrid','SmacLattice','ThetaStar']
    max_cost = 50
    side_buffer = 5
